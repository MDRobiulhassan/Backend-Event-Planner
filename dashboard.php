...
$sql = "SELECT event_id, title, description, venue, date, time FROM Event WHERE user_id = ? ORDER BY date, time";
            ...
            <div class="row m-4">
                ...
                <?php foreach ($upcoming_events as $event): ?>
                    <div class="card ml-3 mb-3" style="width: 18rem;">
                        <?php
                        $event_type = strtolower($event['description']);
                        $default_image = "images/default.jpg";
                        switch ($event_type) {
                            case 'wedding':
                                $default_image = "images/wedding.jpg";
                                break;
                            case 'conference':
                                $default_image = "images/conference.jpg";
                                break;
                            case 'workshop':
                                $default_image = "images/workshop.jpg";
                                break;
                            case 'concert':
                                $default_image = "images/concert.jpg";
                                break;
                            default:
                                $default_image = "images/default.jpg";
                                break;
                        ...
                        ?>
                        <img src="<?php echo $default_image; ?>" class="card-img-top" alt="Event Image">
                        <div class="card-body">
                            ...
                            <p class="card-text">Date: <?php echo htmlspecialchars($event['date']); ?><br>Time:
                                <?php echo htmlspecialchars($event['time']); ?>
                            </p>
                            <a href="eventdetails.php?event_id=<?php echo $event['event_id']; ?>"
                                class="btn btn-primary">Details</a>
                            <a href="editevent.php?event_id=<?php echo $event['event_id']; ?>"
